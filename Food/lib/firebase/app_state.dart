...
class ApplicationState extends ChangeNotifier {
  ...
  Future<DocumentReference> addMessageToGuestBook(
    ...
    String loggedInUser = loggedInUserDisplayName ?? 'Unknown User';
    ...
    return FirebaseFirestore.instance.collection('guestbook').add(messageData);
  }
  ...
  String? get loggedInUserDisplayName {
